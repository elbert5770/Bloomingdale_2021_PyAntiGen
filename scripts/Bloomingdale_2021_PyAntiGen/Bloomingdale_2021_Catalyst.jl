...
function main()
    ...
    for p in parameters(sys)
        ...
        elseif p_name == "BCSFB"
            p_map[p] = 0.0
        elseif p_name == "BrainISF"
            p_map[p] = 0.0
        elseif p_name == "BrainVascular"
            p_map[p] = 0.0
        elseif p_name == "CSF"
            p_map[p] = 0.0
        elseif p_name == "Lymph"
            p_map[p] = 0.0
        elseif p_name == "Plasma"
            p_map[p] = 0.0
        elseif p_name == "TissueEndosomal"
            p_map[p] = 0.0
        elseif p_name == "TissueISF"
            p_map[p] = 0.0
        elseif p_name == "TissueVascular"
            p_map[p] = 0.0
        elseif p_name == "FcRn"
            p_map[p] = FcRn
        end
    ...
    # Create ODE problem
    prob = ODEProblem(complete(sys), u0_vals, (0.0, 1000.0), p_map)
